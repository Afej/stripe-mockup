  ...
  <div class="dashboard">
    ...
    <main class="main-content">
      ...
      <section class="payments">
        ...
        <nav class="payments-nav">
          <ul>
            <li>All</li>
            <li class="active">Succeeded</li>
            <li>Refunded</li>
            <li>Uncaptured</li>
          </ul>
        </nav>
    ...
    this.payments = [
      {
        ...
        amount: "US$352.22",
        description: {
          text: "fe3d8216-58f9-4dc1-aaef-2f19463b5258",
          label: "Succeeded",
        },
